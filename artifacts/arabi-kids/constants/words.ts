...
const RAW_WORDS: Omit<Word, 'imagePath'>[] = [
  ...
  { id: 'an-camel',     english: 'Camel',     arabic: 'جَمَل',       transliteration: 'jamal',   theme: 'animals', difficulty: 'advanced',     icon: 'camel',          color: '#D4A847', photoUrl: U('1769871640750-da076917334f') },
  ...
  { id: 'fo-tea',        english: 'Tea',        arabic: 'شَاي',       transliteration: 'shaay',   theme: 'food', difficulty: 'intermediate', icon: 'tea',            color: '#8D6E63', photoUrl: U('1677528574006-7ba0503f5b0f') },
  ...
  { id: 'fo-chicken',    english: 'Chicken',    arabic: 'دَجَاجَة',   transliteration: 'dajaaja', theme: 'food', difficulty: 'advanced',     icon: 'food-drumstick', color: '#FF8B42', photoUrl: U('1695931841253-1e17e7ed59b5') },
  ...
  { id: 'ho-kitchen',  english: 'Kitchen',    arabic: 'مَطْبَخ',  transliteration: 'matbakh', theme: 'home', difficulty: 'intermediate', icon: 'stove',              color: '#E84848', photoUrl: U('1661963483195-0af65f817b65') },
  ...
  { id: 'ho-carpet',   english: 'Carpet',     arabic: 'سَجَّادَة',transliteration: 'sajjaada',theme: 'home', difficulty: 'advanced',     icon: 'rug',                color: '#E84393', photoUrl: U('1770731617495-5e829ef9eb2b') },
  ...
  { id: 'bo-nose',     english: 'Nose',     arabic: 'أَنْف',    transliteration: 'anf',     theme: 'body', difficulty: 'beginner',     icon: 'nose',            color: '#FF8B42', photoUrl: U('1723111475469-f0a263f87d29') },
  ...
  { id: 'bo-ear',      english: 'Ear',      arabic: 'أُذُن',    transliteration: 'udhun',   theme: 'body', difficulty: 'intermediate', icon: 'ear-hearing',     color: '#FF4D9E', photoUrl: U('1723874502508-453ece1e1d2f') },
  ...
  { id: 'bo-shoulder', english: 'Shoulder', arabic: 'كَتِف',    transliteration: 'katif',   theme: 'body', difficulty: 'advanced',     icon: 'human-handsdown', color: '#6BCB77', photoUrl: U('1671717724551-cf5d5beda05e') },
  { id: 'bo-knee',     english: 'Knee',     arabic: 'رُكْبَة',  transliteration: 'rukba',   theme: 'body', difficulty: 'advanced',     icon: 'human',           color: '#FF6B35', photoUrl: U('1672046218369-67e12ed1c364') },
  ...
  { id: 'bo-cheek',    english: 'Cheek',    arabic: 'خَدّ',     transliteration: 'khadd',   theme: 'body', difficulty: 'advanced',     icon: 'emoticon',        color: '#FF4D9E', photoUrl: U('1683147876693-ea495fbc6eea') },
  ...
  { id: 'na-mountain', english: 'Mountain', arabic: 'جَبَل',    transliteration: 'jabal',   theme: 'nature', difficulty: 'intermediate', icon: 'mountain',             color: '#795548', photoUrl: U('1661963328810-85c3da8ecab5') },
  ...
  { id: 'na-river',    english: 'River',    arabic: 'نَهْر',    transliteration: 'nahr',    theme: 'nature', difficulty: 'intermediate', icon: 'water',                color: '#4FC3F7', photoUrl: U('1668756498138-e6590e05ffa9') },
  ...
  { id: 'cl-dress',    english: 'Dress',    arabic: 'فُسْتَان', transliteration: 'fustan',  theme: 'clothes', difficulty: 'beginner',     icon: 'tshirt-v',      color: '#FF4D9E', photoUrl: U('1732834279072-2b74a26f474d') },
  ...
  { id: 'cl-glasses',  english: 'Glasses',  arabic: 'نَظَّارَة',transliteration: 'nazzaara',theme: 'clothes', difficulty: 'intermediate', icon: 'glasses',       color: '#212121', photoUrl: U('1726754538521-25ed35f0cbb1') },
  { id: 'cl-jacket',   english: 'Jacket',   arabic: 'جَاكِيت', transliteration: 'jaakit',  theme: 'clothes', difficulty: 'intermediate', icon: 'zipper',        color: '#FF6B35', photoUrl: U('1661517042991-3a6aa1aef5b3') },
